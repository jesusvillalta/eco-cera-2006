  ...
  <tr style="background-image:url(../fotos/boca2.jpg);">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="52%"><div id="ruta"><a href="index_en.php">Home</a> &gt; Contact<br />
            </div></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <div id="sectionLinks">
	...
	<?php if (!isset($_POST['nombre']))
		{
            echo '<form action="contacto_en.php" method="post" name="formcontacto">
	<table align="center">
	  <tr>
	    <td>Name<br />
