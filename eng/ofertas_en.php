  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td style="width:52%;"><div id="ruta"><a href="index_en.php">Home</a> &gt; Ofertas<br />
          </div></td>
