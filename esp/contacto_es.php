  ...
  <tr style="background-image:url(../fotos/boca2.jpg);">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="52%"><div id="ruta"><a href="index_es.php">Inicio</a> &gt; Contacto<br />
            </div></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <div id="sectionLinks">
	...
	<?php if (!isset($_POST['nombre']))
		{
            echo '<form action="contacto_es.php" method="post" name="formcontacto">
	<table align="center">
	  <tr>
	    <td>Nombre<br />
