...
<table width="100%" border="0" cellspacing="0">
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td style="width:215px; height:16px;"><div id="direccionweb"><a href="../index.html">www.eco-cera.es</a></div></td>
            <td style="width:52%;"><div id="ruta"><a href="index_ale.php">Startseite</a> &gt; Sucher - Ergebnis<br />
            </div></td>
...
<div id="siteInfo">
  ...
  | <a href="contacto_webmaster_ale.php">Webmaster</a> | <a class="validacion" href="http://validator.w3.org/check?uri=http%3A//www.eco-cera.es/eng/busqueda_ale.php" target="_blank">xhtml</a> | <a href="http://jigsaw.w3.org/css-validator/validator?uri=http://www.eco-cera.es/3col_leftNav.css" class="validacion" target="_blank">css</a></td>
